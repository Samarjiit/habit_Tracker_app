...
const index = () => {
  ...
  const fetchHabits = async () => {
    try {
      const response = await axios.get("http://192.168.1.106:3000/habitslist")
  ...
  const handleCompletion = async () => {
    try {
      ...
      await axios.put(`http://192.168.1.106:3000/habits/${habitId}/completed`, {
  ...
  const deleteHabit = async () => {
    try {
      ...
      const response = await axios.delete(
        `http://192.168.1.106:3000/habits/${habitId}`
      )
